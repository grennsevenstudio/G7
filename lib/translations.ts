...
export const TRANSLATIONS = {
  pt: {
    ...
    landing: {
        ...
        feature_security_title: 'Conta Blindada & PIX Camuflado',
        feature_security_desc: 'Sua conta é protegida com criptografia de ponta e nosso sistema exclusivo de PIX Camuflado, garantindo a segurança e privacidade de suas transações.',
    ...
    faq: [
        ...
        { q: "A PLATAFORMA É SEGURA?", a: "Sim. Sua conta é blindada. Utilizamos criptografia de ponta (AES-256), operamos com 'Cold Wallets' para custódia de ativos e nosso sistema exclusivo de PIX Camuflado protege a privacidade das suas transações." },
  ...
  en: {
    ...
    landing: {
        ...
        feature_security_title: 'Shielded Account & Camouflaged PIX',
        feature_security_desc: 'Your account is protected with top-tier encryption and our exclusive Camouflaged PIX system, ensuring the security and privacy of your transactions.',
    ...
    faq: [
        ...
        { q: "IS THE PLATFORM SECURE?", a: "Yes. Your account is shielded. We use top-tier encryption (AES-256), operate with 'Cold Wallets' for asset custody, and our exclusive Camouflaged PIX system protects the privacy of your transactions." },
  ...
  es: {
    ...
    level_3_desc: 'Expansão de red nivel 3.',
    ...
    planDetails: {
      ...
      select: {
        ...
        risks: ["Alta exposición a activos complejos.", "Requiere mayor tolerancia a oscilações de mercado para ganancias expresivas."]
      }
    },
    ...
    landing: {
        ...
        feature_security_title: 'Cuenta Blindada & PIX Camuflado',
        feature_security_desc: 'Tu cuenta está protegida con cifrado de última generación y nuestro exclusivo sistema de PIX Camuflado, garantizando la seguridad y privacidad de tus transacciones.',
        ...
        cta_button: 'Empezar a Investir en Dólares',
    ...
    faq: [
        ...
        { q: "¿LA PLATAFORMA ES SEGURA?", a: "Sí. Tu cuenta está blindada. Utilizamos cifrado de punta (AES-256), operamos con 'Cold Wallets' para la custodia de activos, y nuestro exclusivo sistema de PIX Camuflado protege la privacidad de tus transacciones." },
  ...
  fr: {
    ...
    landing: {
        ...
        feature_security_title: 'Compte Blindé & PIX Camouflé',
        feature_security_desc: 'Votre compte est protégé par un cryptage de pointe et notre système exclusif de PIX Camouflé, assurant la sécurité et la confidentialité de vos transactions.',
    ...
    faq: [
        ...
        { q: "LA PLATEFORME EST-ELLE SÉCURISÉE ?", a: "Oui. Votre compte est blindé. Nous utilisons un cryptage de pointe (AES-256), opérons avec des 'Cold Wallets' pour la garde des actifs, et notre système exclusif de PIX Camouflé protège la confidentialité de vos transactions." },
  ...
  de: {
    ...
    landing: {
        ...
        feature_security_title: 'Abgeschirmtes Konto & Getarntes PIX',
        feature_security_desc: 'Ihr Konto ist mit erstklassiger Verschlüsselung und unserem exklusiven getarnten PIX-System geschützt, um die Sicherheit und den Datenschutz Ihrer Transaktionen zu gewährleisten.',
    ...
    faq: [
        ...
        { q: "IST DIE PLATTFORM SICHER?", a: "Ja. Ihr Konto ist abgeschirmt. Wir verwenden erstklassige Verschlüsselung (AES-256), arbeiten mit 'Cold Wallets' zur sicheren Verwahrung von Vermögenswerten und unser exklusives getarntes PIX-System schützt die Privatsphäre Ihrer Transaktionen." },
