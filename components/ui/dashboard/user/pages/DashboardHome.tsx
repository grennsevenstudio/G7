    ...
    return (
        <div className="space-y-6 sm:space-y-8 animate-fade-in p-4 sm:p-0 pb-20">
            ...
            <div className="bg-blue-900/40 border border-blue-500/30 p-4 rounded-xl flex items-center gap-4 animate-fade-in">
                ...
                <div>
                    <p className="text-blue-300 font-bold text-sm uppercase">Atualização de Segurança</p>
                    <p className="text-white text-xs">Agora sua conta é <span className="font-black text-brand-green">blindada</span>! Suas transações são protegidas com nosso novo sistema de <span className="font-black text-brand-green">PIX Camuflado</span>.</p>
                </div>
            </div>
