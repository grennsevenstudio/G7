...
const DeleteAccountPage: React.FC<DeleteAccountPageProps> = ({ user, language, onDeleteAccount }) => {
    ...
    // FIX: Extracted conditional className to a variable to simplify the JSX and avoid potential parsing errors.
            ...
            <Card className="border-red-500/30 bg-red-500/5">
                <div className="flex gap-4">
                    <div className="text-red-400 mt-1">
                        {/* FIX: Cast icon to React.ReactElement<any> to allow passing className prop and resolve TypeScript error. */}
                        {React.cloneElement(ICONS.alert as React.ReactElement<any>, { className: 'w-8 h-8' })}
                    </div>
                    <div>
